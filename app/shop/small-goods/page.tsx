...
export const metadata: Metadata = {
  title: "Robin & Wren Studio — Small Goods",
  description: "Tote bags, tea towels, and other small goods featuring Kathy Chandler's watercolors.",
};

export default async function SmallGoodsPage() {
  const products = await getProducts("small-goods");
    ...
    <>
      ...
      <section className="bg-paper pt-10 pb-10 px-6 text-center">
        ...
        <p className="font-heading text-xl font-light italic text-navy/50">
          Useful, beautiful things for every day.
        </p>
      </section>
