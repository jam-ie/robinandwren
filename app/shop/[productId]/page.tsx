...
export async function generateMetadata({
  ...
  if (!product) return {};
  return {
    title: `Robin & Wren Studio — ${product.title}`,
...
const categoryLabels: Record<string, string> = {
  ...
  originals: "Original Paintings",
};

const categoryHrefs: Record<string, string> = {
  prints: "/shop/prints",
  cards: "/shop/cards",
  "small-goods": "/shop/small-goods",
      ...
      <div className="bg-paper border-b border-paper-deeper px-6 py-3">
        <div className="max-w-5xl mx-auto">
          <p className="font-body text-xs tracking-widest text-navy/40">
            ...
            <Link href={categoryHrefs[product.category]} className="hover:text-navy transition-colors">
